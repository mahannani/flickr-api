   <!DOCTYPE html>
    ...
    apiurl_size = "https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=673f243275a37bc649328bd9cdf04ec2&photo_id="+myresult.id+"&format=json&nojsoncallback=1";  
